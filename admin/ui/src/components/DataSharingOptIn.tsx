        ...
        <CardContent className="jwt-space-y-6">
          <div className="jwt-space-y-4">
            <p className="jwt-text-gray-700 jwt-leading-relaxed">
              Hello there! I'm always working to make the JWT Authentication for WP REST API plugin
              better for you. To do this, I'd like to understand the environment where the plugin is
              used. Could you share the following information with me?
            </p>

            <ul className="jwt-space-y-3 jwt-ml-4">
              <li className="jwt-text-gray-700">
                <strong className="jwt-font-semibold">- PHP Version:</strong> This helps me ensure
                compatibility and decide when it's time to phase out older versions.
              </li>
              <li className="jwt-text-gray-700">
                <strong className="jwt-font-semibold">- WordPress Version:</strong> Knowing this
                helps me optimize the plugin for the most common WordPress setups.
              </li>
              <li className="jwt-text-gray-700">
                <strong className="jwt-font-semibold">- WooCommerce Version:</strong> Knowing this
                helps me to understand if I need to focus more on WooCommerce compatibility.
              </li>
              <li className="jwt-text-gray-700">
                <strong className="jwt-font-semibold">- Activated Plugins Count:</strong> This helps
                to know the complexity of the WP installs.
              </li>
            </ul>
            ...
            <p className="jwt-text-gray-700 jwt-leading-relaxed">
              By sharing this information, you're helping me make JWT Authentication for WP REST API
